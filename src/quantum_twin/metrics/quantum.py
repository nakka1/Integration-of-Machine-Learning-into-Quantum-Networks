...
from .prediction import ArrayLike, find_threshold_crossings


def compute_qpu_economy(metrics: dict, baseline_metrics: dict, shots_per_attempt: int | None = None) -> dict:
    """
...
def compute_fidelity_statistics(y_true: ArrayLike, threshold: float = 0.65) -> dict:
    """
